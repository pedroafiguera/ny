...
class StreetsControllerTest < ActionController::TestCase
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post :create, street: { alternate-parking: @street.alternate-parking, direction: @street.direction, name: @street.name }
    end
  ...
  test "should update street" do
    patch :update, id: @street, street: { alternate-parking: @street.alternate-parking, direction: @street.direction, name: @street.name }
    assert_redirected_to street_path(assigns(:street))
  end
